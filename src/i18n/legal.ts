...
const en: LegalSet = {
  privacy: {
    ...
    sections: [
      ...
      { h2: '10. Changes & contact', body: 'We may update this policy and will post the new date above. Questions? Contact kernstemcare@gmail.com · Retorno Viento, SM 4, Núm. 10, Benito Juárez, Cancún, Q.R., México.' },
    ],
  ...
  terms: {
    ...
    sections: [
      ...
      { h2: '5. Intellectual property', body: 'All content on this site (text, logos, images, video) is owned by Kern Stem Care (Kern Corsa Medical Group, S.A. de C.V.) or its licensors and may not be copied or reused without permission.' },
      ...
      { h2: '8. Governing law', body: 'These terms are governed by the laws of Quintana Roo, Mexico, without regard to conflict-of-law rules.' },
      { h2: '9. Changes & contact', body: 'We may update these terms and will post the new date above. Questions? Contact kernstemcare@gmail.com.' },
    ],
    backHome: '← Back to home',
...
const es: LegalSet = {
  privacy: {
    ...
    sections: [
      ...
      { h2: '10. Cambios y contacto', body: 'Podemos actualizar esta política y publicaremos la nueva fecha arriba. ¿Dudas? Contacte a kernstemcare@gmail.com · Retorno Viento, SM 4, Núm. 10, Benito Juárez, Cancún, Q.R., México.' },
    ],
  ...
  terms: {
    ...
    medDisclaimer:
      '<strong>Aviso de agencia y médico.</strong> Kern Stem Care es una <strong>agencia de coordinación médica y de viajes</strong>. <strong>No somos una clínica, hospital ni proveedor médico</strong> y no brindamos tratamiento, diagnóstico ni consejo médico. Toda la atención médica la brindan clínicas, médicos y laboratorios independientes y con licencia. El contenido de este sitio es solo para fines informativos generales. Muchas terapias regenerativas y celulares coordinadas a través de nuestros aliados <strong>no están aprobadas por la FDA de EE.UU. ni por Health Canada</strong> para enfermedades específicas y se consideran de investigación. Ni nosotros ni nuestros aliados garantizamos ningún resultado ni cura. Los resultados individuales varían. Consulte siempre a un médico calificado antes de tomar una decisión médica.',
    sections: [
      ...
      { h2: '2. Sin relación médico–paciente con nosotros', body: 'Usar este sitio, contactarnos o enviar un formulario no crea una relación médico–paciente con Kern Stem Care. Dicha relación se forma solo con un proveedor médico con licencia tras una evaluación formal y un acuerdo por escrito.' },
      ...
      { h2: '5. Propiedad intelectual', body: 'Todo el contenido de este sitio (texto, logos, imágenes, video) es propiedad de Kern Stem Care (Kern Corsa Medical Group, S.A. de C.V.) o sus licenciantes y no puede copiarse ni reutilizarse sin permiso.' },
      ...
      { h2: '8. Ley aplicable', body: 'Estos términos se rigen por las leyes de Quintana Roo, México, sin atender a normas de conflicto de leyes.' },
      { h2: '9. Cambios y contacto', body: 'Podemos actualizar estos términos y publicaremos la nueva fecha arriba. ¿Dudas? Contacte a kernstemcare@gmail.com.' },
    ],
    backHome: '← Volver al inicio',
  ...
  medical: {
    ...
    medDisclaimer:
      '<strong>Kern Stem Care es una agencia de coordinación médica y de viajes — no una clínica, hospital ni proveedor médico.</strong> No brindamos tratamiento, diagnóstico ni consejo médico. Toda la atención médica la brindan clínicas, médicos y laboratorios independientes y con licencia. La información aquí es general y educativa.',
    sections: [
      { h2: '1. Rol de agencia, no clínica', body: 'Kern Stem Care coordina viaje, hospedaje, citas y acompañamiento, y le conecta con proveedores independientes y con licencia. No ejercemos la medicina.' },
      ...
      { h2: '3. Sin relación médico–paciente', body: 'Usar este sitio, contactarnos o enviar un formulario no crea una relación médico–paciente. Dicha relación se forma solo con un proveedor con licencia tras una evaluación formal.' },
...
/**
 * The site's single consolidated legal/medical disclaimer, rendered once at the foot
 * of every page by `LegalDisclaimer.astro` (via SiteLayout). It replaces what used to
 * be several separate per-section notices; keep it as the one place this text lives.
 */
export const siteDisclaimer: Record<Lang, string> = {
  en: '<strong>Important — please read.</strong> Kern Stem Care is a medical coordination agency, not a clinic. We do not provide medical treatment or medical advice. All care is delivered by independent, government-licensed (COFEPRIS) clinics, physicians, and laboratories in Cancún, Mexico, who quote and are responsible for their own services. Many regenerative and cellular therapies are not approved by the U.S. FDA or Health Canada for specific diseases and are considered investigational. Individual results vary; no outcome or cure is guaranteed. Patient testimonials reflect individual experiences, are shared with written consent, and are not a promise of results. Membership fees cover our coordination and concierge services only — medical treatment, evaluations, and travel costs are quoted separately by the provider. Content on this site is educational and is not a substitute for consultation with a licensed physician.',
  es: '<strong>Importante — por favor léelo.</strong> Kern Stem Care es una agencia de coordinación médica, no una clínica. No brindamos tratamiento ni consejo médico. Toda la atención la brindan clínicas, médicos y laboratorios independientes con licencia gubernamental (COFEPRIS) en Cancún, México, quienes cotizan y son responsables de sus propios servicios. Muchas terapias regenerativas y celulares no están aprobadas por la FDA de EE.UU. ni por Health Canada para enfermedades específicas y se consideran de investigación. Los resultados individuales varían; no se garantiza ningún resultado ni cura. Los testimonios reflejan experiencias individuales, se comparten con consentimiento por escrito y no son una promesa de resultados. Las cuotas de membresía cubren únicamente nuestros servicios de coordinación y concierge — el tratamiento médico, las evaluaciones y los costos de viaje los cotiza por separado el proveedor. El contenido de este sitio es educativo y no sustituye la consulta con un médico certificado.',
};
