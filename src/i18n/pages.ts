...
const en: PagesSet = {
  services: {
    metaTitle: 'Services | Kern Stem Care',
    metaDescription:
      'The cellular therapies and care areas we help patients access through independent, licensed clinics and laboratories in Cancún.',
  ...
  stemCells: {
    metaTitle: 'Stem Cells | Kern Stem Care',
    metaDescription: 'Stem-cell therapy coordinated by Kern Stem Care with independent, licensed partner providers in Cancún.',
    eyebrow: 'Cellular Therapy',
    title: 'Stem Cells',
    lead: 'An overview of the stem-cell therapy our partner network provides. <span class="ph">[Replace with your own introduction.]</span>',
    sections: [
      { h2: 'What it is', body: 'Stem cells are cells with the ability to develop into different cell types, widely studied for their role in tissue repair and regeneration. <span class="ph">[Edit with the specific stem-cell sources your partners use.]</span>' },
      ...
      { h2: 'What to expect', body: 'Every plan begins with a medical evaluation performed by the provider, not by us. We coordinate the appointment, travel, and logistics around it. <span class="ph">[Describe the typical journey.]</span>' },
    ],
    disclaimer: investigationalEN,
  },
  exosomes: {
    metaTitle: 'Exosomes | Kern Stem Care',
    metaDescription: 'Exosome therapy coordinated by Kern Stem Care with independent, licensed partner providers in Cancún.',
    eyebrow: 'Cellular Therapy',
    title: 'Exosomes',
  ...
  fibroblasts: {
    metaTitle: 'Fibroblasts | Kern Stem Care',
    metaDescription: 'Fibroblast therapy coordinated by Kern Stem Care with independent, licensed partner providers in Cancún.',
    eyebrow: 'Cellular Therapy',
    title: 'Fibroblasts',
  ...
  about: {
    ...
    metaDescription: 'Kern Stem Care is a medical coordination agency in Cancún — not a clinic — guiding patients from the U.S. and Canada.',
  ...
  process: {
    metaTitle: 'International Patients | Kern Stem Care',
    metaDescription: 'The step-by-step process for U.S. and Canadian patients coordinating care in Cancún with Kern Stem Care.',
  ...
  testimonials: {
    ...
    metaDescription: 'Patient stories shared with written consent. Results are not typical and vary from person to person.',
  ...
  contact: {
    ...
    metaDescription: 'Request your free, no-obligation evaluation. A patient coordinator will reach out within 24 hours.',
    eyebrow: 'Get Started',
...
const es: PagesSet = {
  services: {
    metaTitle: 'Servicios | Kern Stem Care',
    metaDescription:
      'Las terapias celulares y áreas de atención a las que ayudamos a acceder a través de clínicas y laboratorios independientes y certificados en Cancún.',
  ...
  stemCells: {
    metaTitle: 'Células Madre | Kern Stem Care',
    metaDescription: 'Terapia con células madre coordinada por Kern Stem Care con proveedores aliados independientes y certificados en Cancún.',
    eyebrow: 'Terapia Celular',
    title: 'Células Madre',
    lead: 'Un resumen de la terapia con células madre que ofrece nuestra red de aliados. <span class="ph">[Reemplazar con tu introducción.]</span>',
    sections: [
      { h2: 'Qué es', body: 'Las células madre tienen la capacidad de transformarse en distintos tipos celulares, ampliamente estudiadas por su papel en la reparación y regeneración de tejidos. <span class="ph">[Editar con las fuentes específicas que usan tus aliados.]</span>' },
      ...
      { h2: 'Qué esperar', body: 'Cada plan inicia con una evaluación médica realizada por el proveedor, no por nosotros. Coordinamos la cita, el viaje y la logística alrededor. <span class="ph">[Describe el proceso típico.]</span>' },
    ],
    disclaimer: investigationalES,
  },
  exosomes: {
    metaTitle: 'Exosomas | Kern Stem Care',
    metaDescription: 'Terapia con exosomas coordinada por Kern Stem Care con proveedores aliados independientes y certificados en Cancún.',
    eyebrow: 'Terapia Celular',
    title: 'Exosomas',
  ...
  fibroblasts: {
    metaTitle: 'Fibroblastos | Kern Stem Care',
    metaDescription: 'Terapia con fibroblastos coordinada por Kern Stem Care con proveedores aliados independientes y certificados en Cancún.',
    eyebrow: 'Terapia Celular',
    title: 'Fibroblastos',
  ...
  about: {
    ...
    metaDescription: 'Kern Stem Care es una agencia de coordinación médica en Cancún — no una clínica — que guía a pacientes de EE.UU. y Canadá.',
  ...
  process: {
    metaTitle: 'Pacientes Internacionales | Kern Stem Care',
    metaDescription: 'El proceso paso a paso para pacientes de EE.UU. y Canadá que coordinan su atención en Cancún con Kern Stem Care.',
  ...
  testimonials: {
    ...
    metaDescription: 'Historias de pacientes compartidas con consentimiento por escrito. Los resultados no son típicos y varían de persona a persona.',
  ...
  contact: {
    ...
    metaDescription: 'Solicite su evaluación gratuita, sin compromiso. Un coordinador le contactará en menos de 24 horas.',
    eyebrow: 'Comenzar',
