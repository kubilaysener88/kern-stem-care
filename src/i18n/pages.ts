...
const en: PagesSet = {
  ...
  process: {
    ...
    sections: [
      { h2: 'Travel & logistics', body: 'Cancún International (CUN) is a major hub with direct flights from cities across the Americas, Europe, and beyond — including most major U.S. and Canadian cities. Nonstop flights run about 2 hours from Miami or Houston, and around 4 hours from New York or Toronto. We provide flight guidance as part of coordinating your trip. Airport transfers and lodging near the partner clinic are <strong>optional services with their own cost</strong>, quoted separately from your treatment — take them and travel logistics become one less thing to plan, or arrange your own and nothing about your care changes.' },
