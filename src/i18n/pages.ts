...
const es: PagesSet = {
  ...
  about: {
    ...
    sections: [
      { h2: 'Quiénes somos', body: 'Kern Stem Care es una agencia de coordinación médica operada por Kern Corsa, S.A. de C.V., una empresa legalmente constituida en Cancún, México. Elegir dónde realizarte un tratamiento en otro país es una de las decisiones más importantes que tomarás — y ahí está nuestro valor: verificamos cada clínica, médico y laboratorio de nuestra red, coordinamos cada etapa y acompañamos a pacientes de Estados Unidos y Canadá de principio a fin. La atención médica la brindan esos proveedores independientes y acreditados; nuestro trabajo es asegurarnos de que sean los correctos para ti.' },
