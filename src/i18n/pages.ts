...
const es: PagesSet = {
  ...
  about: {
    ...
    sections: [
      ...
      { h2: 'Nuestra red', body: 'No cualquier clínica entra a nuestra red. Una clínica, médico o laboratorio se convierte en aliado solo después de cumplir nuestros criterios de verificación — empezando por una licencia vigente de la autoridad sanitaria de México (COFEPRIS), e incluyendo las credenciales, los estándares y los controles de calidad que completamos antes de conectar a un solo paciente. Así, quienes llegan con nosotros acceden a terapias regenerativas y con células madre en Cancún a través de una red cuidadosamente verificada — en manos de confianza desde el primer día.' },
    ],
  },
  process: {
