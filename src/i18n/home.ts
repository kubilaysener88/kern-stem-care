...
const en: HomeContent = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'How do I travel to Cancún?', a: 'Cancún International (CUN) has direct flights from most major U.S. and Canadian cities — nonstop flights run about 2 hours from Miami or Houston and around 4 hours from New York or Toronto. We provide flight guidance, airport pickup, and lodging near the partner clinic, so travel logistics are one less thing to plan.', href: '/en/process#travel-logistics' },
      { q: 'How much does it cost, and who do I pay?', a: 'You receive one transparent, itemized quote before committing — medical, travel, and coordination costs clearly broken down. You pay Kern Stem Care directly, and we handle payment to your medical provider and other partners on your behalf, so you are never juggling multiple invoices in a foreign currency.', href: '/en/process#costs-payments' },
      ...
      { q: 'What support do I get after returning home?', a: 'You are not on your own once you leave Cancún. We help coordinate remote follow-up appointments with your provider, and your bilingual coordinator stays in contact with you after you return home — for aftercare questions, paperwork, or anything in between.', href: '/en/process#follow-up-at-home' },
    ],
  },
  membership: {
    eyebrow: 'Membership',
...
const es: HomeContent = {
  ...
  faq: {
    ...
    items: [
      { q: '¿Está aprobado este tratamiento por la FDA o Health Canada?', a: 'Muchas terapias regenerativas no están aprobadas por la FDA ni por Health Canada para enfermedades específicas y se consideran de investigación. Somos transparentes sobre el estatus regulatorio y de evidencia de cada terapia que coordinamos, y el médico tratante lo revisa contigo durante tu consulta — antes de tomar cualquier decisión.', href: '/es/blog/es-legal-la-terapia-con-celulas-madre-en-mexico' },
      ...
      { q: '¿Qué apoyo recibo al volver a casa?', a: 'No te quedas solo al salir de Cancún. Ayudamos a coordinar las citas de seguimiento remoto con tu proveedor, y tu coordinador bilingüe permanece en contacto contigo después de volver a casa — para dudas del cuidado posterior, trámites o lo que se necesite.', href: '/es/process#seguimiento-en-casa' },
    ],
  },
  membership: {
    eyebrow: 'Membresía',
