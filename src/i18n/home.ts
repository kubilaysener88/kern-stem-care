...
const en: HomeContent = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'How many days do I need to stay in Cancún for stem cell treatment with Kern Stem Care?', a: 'A typical stay is three days: day one you arrive and settle in, day two is your treatment at the partner clinic, and day three you fly home. We coordinate your airport pickup, lodging, and appointments so the whole stay runs on one clear itinerary — and if your medical plan calls for anything different, you will know before you book your flights.', href: '/en/process' },
