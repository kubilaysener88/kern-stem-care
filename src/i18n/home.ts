...
const en: HomeContent = {
  ...
  treatments: {
    ...
    cards: [
      { icon: '🦵', title: 'Joint & Orthopedic', slug: 'stem-cells', body: 'Programs focused on joints, tendons, and musculoskeletal comfort and mobility. <span class="ph">[Edit description]</span>' },
      { icon: '🏃', title: 'Sports Injury & Recovery', slug: 'stem-cells', body: 'Recovery-focused programs for active patients and athletes. <span class="ph">[Edit description]</span>' },
      { icon: '🛡️', title: 'Immune Wellness & Support', slug: 'placenta', body: 'Wellness programs supporting immune health and resilience. <span class="ph">[Edit description]</span>' },
      { icon: '✨', title: 'Anti-Aging & Longevity', slug: 'stem-cells', body: 'Vitality and longevity-oriented wellness programs. <span class="ph">[Edit description]</span>' },
      { icon: '🌿', title: 'Senior Health & Wellness', slug: 'stem-cells', body: 'Wellness programs tailored to the needs of older adults. <span class="ph">[Edit description]</span>' },
      { icon: '💆', title: 'Aesthetic & Skin', slug: 'fibroblasts', body: 'Skin, rejuvenation, and aesthetic wellness — a natural fit for fibroblast applications. <span class="ph">[Edit description]</span>' },
...
const es: HomeContent = {
  ...
  treatments: {
    ...
    cards: [
      { icon: '🦵', title: 'Articular y Ortopédico', slug: 'stem-cells', body: 'Programas enfocados en articulaciones, tendones y movilidad musculoesquelética. <span class="ph">[Editar descripción]</span>' },
      { icon: '🏃', title: 'Lesiones Deportivas y Recuperación', slug: 'stem-cells', body: 'Programas de recuperación para pacientes activos y atletas. <span class="ph">[Editar descripción]</span>' },
      { icon: '🛡️', title: 'Bienestar y Soporte Inmune', slug: 'placenta', body: 'Programas de bienestar que apoyan la salud y resiliencia inmune. <span class="ph">[Editar descripción]</span>' },
      { icon: '✨', title: 'Antienvejecimiento y Longevidad', slug: 'stem-cells', body: 'Programas de bienestar orientados a la vitalidad y la longevidad. <span class="ph">[Editar descripción]</span>' },
      { icon: '🌿', title: 'Salud y Bienestar del Adulto Mayor', slug: 'stem-cells', body: 'Programas de bienestar adaptados a las necesidades de los adultos mayores. <span class="ph">[Editar descripción]</span>' },
      { icon: '💆', title: 'Estética y Piel', slug: 'fibroblasts', body: 'Piel, rejuvenecimiento y bienestar estético — encaja de forma natural con las aplicaciones de fibroblastos. <span class="ph">[Editar descripción]</span>' },
